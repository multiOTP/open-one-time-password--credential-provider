...
class COpenOTPProvider : public ICredentialProvider
{
  public:
    // IUnknown
    ...
    IFACEMETHODIMP QueryInterface(__in REFIID riid, __deref_out void** ppv)
    {
        ...
        {
            QITABENT(COpenOTPProvider, ICredentialProvider), // IID_ICredentialProvider
            {0},
        };
...
private:
    LONG									_cRef;
    COpenOTPCredential						*_rgpCredentials[MAX_CREDENTIALS];  // Pointers to the credentials which will be enumerated by 
																				// this Provider.
    //DWORD                                   _dwNumCreds;
